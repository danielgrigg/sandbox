...
countdownd.hello.foo = "foo";
countdownd.hello.bar = function bar(x) {
  var y__24147 = x * 2;
  return cljs.core.PersistentVector.fromArray([x, y__24147])
};
countdownd.hello.baz_destruct = function baz_destruct(p__24148, n) {
  var map__24149__24150 = p__24148;
  var map__24149__24151 = cljs.core.seq_QMARK_.call(null, map__24149__24150) ? cljs.core.apply.call(null, cljs.core.hash_map, map__24149__24150) : map__24149__24150;
  var surname__24152 = cljs.core.get.call(null, map__24149__24151, "\ufdd0'surname");
  var first_name__24153 = cljs.core.get.call(null, map__24149__24151, "\ufdd0'first-name");
  return[cljs.core.str("first-name "), cljs.core.str(first_name__24153), cljs.core.str(" surname "), cljs.core.str(surname__24152), cljs.core.str(" n "), cljs.core.str(n)].join("")
};
countdownd.hello.o = {"foo":1, "bar":2};
console.log("Hello world from js/console 2;", countdownd.hello.baz_destruct.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'first-name", "\ufdd0'surname"], {"\ufdd0'first-name":"Jane", "\ufdd0'surname":"Smith"}), 32), "; ", countdownd.hello.o);
cljs.core.println.call(null, "Hello world from REPL");
