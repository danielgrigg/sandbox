...
bool initShaders()
{
  ...
  sources.push_back("texarrays.fp");
  sources.push_back("texarrays.vp");
  ...
  g_moonColorMap = loadTextureArrayFromFiles("../Resources/moon", 64, 64, 29, 
...
void drawGeometry()
{
  ...
  float textureIndex = fmod(t, 29.0);
...
void setupRC()
{
  ...
  uniforms[kTextureIndex] = glGetUniformLocation(g_shader.program(), "textureIndex");
  initGeometry();
